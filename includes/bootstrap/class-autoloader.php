<?php
/**
 * CB Child Autoload Implementation.
 *
 * @package    CB_Child
...
/**
 * Auto Loader for CB_Child.
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the CB_Child\Bar\Baz\Qux class
 * from /path/to/wp-content/themes/community-builder-child/includes/bar/baz/class-qux.php:
 *
 *      new CB_Child\Baz_Xyz\Qux;
 *  maps to /path/to/wp-content/themes/community-builder-child/includes/bar/baz-xyz/class-qux.php
...
class Autoloader {
	...
	/**
	 * Namespace root. eg. BP_Emoji\\(escaped slashes);
	 *
	 * @var string
	 */
